...
// Release signing comes from keystore.properties at the repo root (gitignored). Without it,
// release builds stay unsigned, so CI and other machines still build.
